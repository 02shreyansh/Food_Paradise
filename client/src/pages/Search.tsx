                                    ...
                                    appliedFilter.map((selectedFilter: string, idx: number) => (
                                        <div key={idx}
                                            ...
                                            <Badge className="text-[#D19254] rounded-md hover:cursor-pointer pr-6 whitespace-nowrap"
                                                variant="outline">{selectedFilter}</Badge>
                                            <X
                                    ...
                                    <Card key={restaurant._id} className="bg-white dark:bg-gray-800 shadow-xl rounded-xl overflow-hidden hover:shadow-2xl transition-shadow duration-300">
                                        ...
                                        <CardContent className="p-4">
                                            ...
                                            <div className="flex gap-2 mt-4 flex-wrap">
                                                {
                                                    restaurant.cuisines.map((cusine: string, idx: number) => (
                                                        <Badge key={idx} className="font-medium px-2 py-1 rounded-full shadow-sm">{cusine}</Badge>
                                                    ))
                                                }
                                            </div>
                                        </CardContent>
